...
Reach customers faster and stay on top of inbound activity. Send and read SMS threads, and triage voicemails — all through your AI client.

## What it does

The RingCentral MCP server gives your AI the ability to act on your communications stack, not just read from it. Your AI can send SMS messages, read incoming texts, and surface unheard voicemails — enabling fully conversational customer engagement workflows without switching between apps.
...
!!! warning "Outbound actions require confirmation"
    Prompts that send messages are irreversible. Most AI clients will ask for your approval before executing any tool that writes or acts.
